 ...
 * @brief 修正墙壁二段跳的bug+修正主人公空间碰撞旋转bug+实现死亡后复活逻辑+实现通关后静止逻辑+代码美化
 *        1. 更改了主人公图片大小，将scale参数调整至1
 * @author ZHY
...
//--------以下为Start部分的初始化函数--------//
    ...
    {
        transform.localPosition = new Vector3(-4.37f, -7.76f, -0.33f); // 仅适用于DEMO演示中的关卡！！！
...
//--------以下为Update部分的状态转移与判断函数--------//
    ...
    public void changeState(PlayerState state) // 状态修正函数
    {
        currentState = state;
    }
